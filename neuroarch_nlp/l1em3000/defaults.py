...
neuron_types = {
    ...
    'mbon': query_str['MBON'], 'mushroom body output': query_str['MBON'],'mbons':query_str['MBON'],
    ...
    'lhon': query_str['LHON'], 'lhons': query_str['LHON'], 'lateral horn output': query_str['LHON'],
    'mb2on': query_str['MB2ON'], 'mb2ons': query_str['MB2ON'],
    'ffn': query_str['FFN'], 'ffns': query_str['FFN'], 'feedforward': query_str['FFN'],
    'motor': query_str['Motor'], 'motors': query_str['Motor'], 'motor': query_str['Motor'],
    'pmn': query_str['PMN'], 'pmns': query_str['PMN'], 'premotor': query_str['PMN'], 'pre-motor': query_str['PMN'],
